...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMyThirdPersonGameModeBase_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AMyThirdPersonGameModeBase_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_AMyThirdPersonGameModeBase()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AMyThirdPersonGameModeBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AMyThirdPersonGameModeBase, 247267481);
	template<> MYTHIRDPERSON_API UClass* StaticClass<AMyThirdPersonGameModeBase>()
	{
		return AMyThirdPersonGameModeBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyThirdPersonGameModeBase(Z_Construct_UClass_AMyThirdPersonGameModeBase, &AMyThirdPersonGameModeBase::StaticClass, TEXT("/Script/MyThirdPerson"), TEXT("AMyThirdPersonGameModeBase"), false, nullptr, nullptr, nullptr);
